        ...
        <div className="flex-1 flex flex-col">
          ...
          <main className="p-6 space-y-6">
            ...
            <section className="bg-blue-500 text-white rounded-lg p-6">
              ...
              <button className="my-4 bg-white text-blue-500 px-4 py-2 rounded-lg font-semibold hover:bg-gray-100">
                Browser Name Courses
              </button>
            </section>
            ...
            <section className="grid grid-cols-1 md:grid-cols-4 gap-4">
              {[
                { label: "total Enrolled Couses", value: 5 },
                { label: "Complete Assignment", value: 12 },
                { label: "Pending Quize", value: 3 },
                { label: "Purchsed Courses", value: 2 },
              ].map((stat) => (
                <div
                  key={stat.label}
